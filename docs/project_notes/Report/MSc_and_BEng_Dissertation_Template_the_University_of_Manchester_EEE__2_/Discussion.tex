...
The project required significant self-directed learning, documented in the CPD log (Appendix~\ref{app:cpd_log}), including real-time systems, multithreaded architectures, physics simulation, and haptic control. This informed key design decisions such as snapshot-based communication and damping-based stabilisation.
