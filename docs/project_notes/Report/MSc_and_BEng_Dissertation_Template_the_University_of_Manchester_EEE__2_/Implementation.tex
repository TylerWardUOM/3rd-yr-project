...
As a result, stability in the implemented system is not guaranteed by formal passivity conditions, but is instead achieved through a combination of virtual coupling, damping, and conservative actuator-side constraints. These mechanisms act to limit energy injection arising from delay and discretisation, providing practical stability despite the absence of a formally passive design.
%TODO: Check that this as a result paragraph should be here could maybe be moved into discussion
