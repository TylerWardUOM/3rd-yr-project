...
Consequently, stability is achieved in practice through virtual coupling, damping, and conservative actuator-side constraints, which limit energy injection arising from delay and discretisation. The passivity implications of this design and its performance under communication delay are discussed further in Section~\ref{sec:discussion}.
