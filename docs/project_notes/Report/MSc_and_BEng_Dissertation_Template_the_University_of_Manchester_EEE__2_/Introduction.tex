...
Robotic manipulators are increasingly used in domains such as industrial automation, teleoperation, and robot-assisted surgery, where safe and effective interaction with physical environments is essential. % cut? In many of these contexts, operator training plays a critical role in determining task quality, safety, and efficiency.
 Although visual feedback provides important global information about the workspace, it alone may be insufficient for developing fine motor control, accurate force regulation, and intuitive understanding of contact conditions.%TODO Maybe strengthen claim with evidence
...
This dissertation addresses the design and evaluation of a \emph{low-cost, real-time haptic interface system} suitable for robotic manipulation training and experimentation, with explicit consideration of the practical constraints that arise in implementation.
