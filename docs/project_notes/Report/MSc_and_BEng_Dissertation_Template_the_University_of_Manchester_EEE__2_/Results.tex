...
Despite this non-uniform host-side processing pattern, analysis of MCU-side timestamps showed that the embedded system maintained a consistent update rate. The effective MCU period per state was approximately 1.00~ms, corresponding to an update rate of 1000~Hz, with very low variability.
